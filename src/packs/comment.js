...
(function() {
  ...
  addComment = function(data) {
    ...
    id = imgId++;
    row = `<tr> <td class='user-column'> <img class='avatar' id='user-img-${id}' src='https://image.showroom-cdn.com/showroom-prod/image/avatar/${avatar}.png'> ${name} </td> <td class='date-column'>${data['time']}</td> <td>${comment}</td> </tr>`;
  ...
  addGift = function(data) {
    ...
    id = imgId++;
    row = `<tr> <td class='user-column'> <img class='avatar' id='user-img-${id}' src='https://image.showroom-cdn.com/showroom-prod/image/avatar/${avatar}.png'> ${name} </td> <td class='date-column'>${data['time']}</td> <td> <img class='gift' id='gift-img-${id}' src='https://static.showroom-live.com/image/gift/${gift}_s.png'> <span class='gift-num'>x${num}</span> </td> </tr>`;
